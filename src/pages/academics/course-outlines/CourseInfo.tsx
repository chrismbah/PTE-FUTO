    ...
    <div className="bg-gray-50 min-h-screen">
      {courseInfo ? (
        <div className="max-w-[1000px] mx-auto">
          <div className="px-3 pt-20 pb-8 xsm:px-14 xsm:pt-24 xsm:pb-10 ">
            <div className="flex items-center justify-center">
              <div className="flex-center gap-0 ss:gap-3 flex-wrap">
                <div className="flex-center">
                  <img src={file} alt="Book" className="w-10 sm:w-10 sm:mr-1" />
                  <h3 className="text-lg sm:text-2xl font-[600]">
            ...
            {courseInfo.info.map(({ heading, content }, index) => (
              <div key={index} className="py-2 mb-2 border-b-2 border-gray-200">
                {heading && (
