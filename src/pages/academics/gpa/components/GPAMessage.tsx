...
export const GPAMessage = () => {
  ...
  if (studentGPA >= 4.5 && studentGPA <= 5.0) {
    return (
      <div className="text-ss sm:text-sm font-medium text-gray-700">
        1st Class !!
      </div>
    );
    ...
    return (
      <div className="text-ss sm:text-sm font-medium text-gray-700">Pass</div>
    );
  } else if (studentGPA >= 0.0 && studentGPA <= 0.99) {
    return (
      <div className="text-ss sm:text-sm font-medium text-red-600">Fail</div>
    );
  }
};
