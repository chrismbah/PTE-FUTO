        ...
        <div className="page-section">
          <div className="w-full flex items-center justify-center mb-6 flex-col">
            ...
            <p className="text-center text-xs xsm:text-base">
              {`Explore essential study resources compiled just for ${level === "100" ? "freshers" : level === "500" ? "final year students" : `${level} level students`}`}{" "}
              <br />
          ...
          <h4 className="text-md font-bold mb-2">
            First Semseter <div className="bar-style" />
          </h4>
          ...
          {level && courses[level]["Second"].courseCodes.length > 0 ? (
            <>
              ...
              <div className="grid items-center xxss:grid-cols-2 ss:grid-cols-3 sm:grid-cols-4 mmd:grid-cols-5 gap-4 ">
