      ...
      courseInfo: [
        {
          ...
          id: "MTH 101",
          tip: "Attend classes regularly and study compiled and summarized learning materials if available and take tutorials if you have trouble self learning. Make sure all assignments, workbooks, or manuals are properly done. Never miss a day of practicals if the course has any. It could lead to an automatic FAIL. It is advisable to start studying before exams are around the corner.",
        },
        {
          courseCode: "PHY 101",
