...
export const EditProfileModal = () => {
  ...
  const { studentDetails, getUserInfo, user, userID } = useGetUserInfo();
      ...
      if (studentDetails.profileImageURL.length > 0 || imageURL) {
        ...
        return (
          <Lottie
            ...
            loop={false}
            className="w-[70px] xss:w-[90px]
              sm:w-[120px] mmd:w-[220px]"
          />
        );
      }
    }
     ...
     { studentDetails && <div
      ...
      >
        {/* <form onSubmit={handleSubmit(editProfile)}> */}
          <div className="bg-white rounded-lg  text-center relative shadow-4 w-[700px]">
            ...
            <div>
              <div className="flex flex-col xss:flex-row items-center gap-3 w-full mmd:w-fit py-4 px-6 ">
                {renderProfileImage()}
            ...
            <div className="w-full flex items-center justify-between gap-2 py-4 px-6">
              <button
                onClick={closeEditProfileModal}
