...
export const DeleteCommentModal:FC<ModalProp> = ({commentID, commentUserID}) => {
  ...
  return (
    <>
      <div
        className={`${openDeleteModal ? "block" : "hidden bg-transparent"
        } z-[9999999999] bg-black/50 backdrop-blur-sm fixed top-0 right-0 left-0  min-h-screen overflow-y-auto overflow-x-hidden flex items-center justify-center`}
      >
