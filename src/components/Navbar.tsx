...
export default function Nav() {
  return (
    <Navbar fluid rounded theme={customNavTheme} className="font-dmSans fixed w-full shadow-sm">
      ...
      <div className="flex md:order-2">
        <Button theme={customButtonTheme} color="primary" size="md" className="focus:outline-none" >Log In</Button>
      ...
      <Navbar.Collapse className="xmd:block xmd:w-auto" >
        ...
        <Navbar.Link href="#">
          <Dropdown arrowIcon={true} inline label={"Alumini"} theme={customDropdownTheme}>
